...
- [x] Transitions between screens/states — `UIScreen` sub-trees + `UIScreenStack` on the canvas, driven
...
- [x] **Screen/navigation stack** (pages, push/pop, back) with fade+slide transitions — see F
