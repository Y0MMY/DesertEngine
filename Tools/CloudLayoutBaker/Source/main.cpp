...
//
// `--image` is the path an artist takes, and it is the same path: the PNG is read to RGBA8 and handed to
// exactly the function the panel calls. The tool and the panel cannot disagree about what a picture means
