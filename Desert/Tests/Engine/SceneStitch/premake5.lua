...
project(test_name)
    ...
    -- through Scene.hpp and no test project can compile it; that is exactly why the stitch was moved out.
    -- Nothing to link but Common, and that is the proof the function is pure.
    files {
        test_files,
    }
