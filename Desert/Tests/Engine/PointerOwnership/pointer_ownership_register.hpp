...
namespace Desert::Tests::PointerCensus
{
    ...
    inline const std::vector<Row>& Register()
    {
        ...
        { "Editor/Source/Editor/Panels/Modeling/ModelingPanel.cpp",
          ...
          "a string literal, held by a constexpr/static table entry" },
        { "Editor/Source/Editor/Panels/Modeling/ModelingPanel.cpp",
          "ToolBtn", "Icon", Guard::StaticStorage,
          "a string literal, held by a constexpr/static table entry" },
        { "Editor/Source/Editor/Panels/Modeling/ModelingPanel.cpp",
          "ToolBtn", "Name", Guard::StaticStorage,
          "a string literal, held by a constexpr/static table entry" },
        ...
        { "Desert/Desert/Source/Engine/Core/Scene.hpp",
          "Scene", "m_SceneRenderer", Guard::HostOutlivesUs,
          "handed to the constructor and never reassigned; the renderer is owned by whoever created the scene (EditorLayer, or a SceneDocument), and a scene is destroyed before the renderer whose slot it draws into -- which is the order Docs/RENDERER_FRAME_STATE.md requires so a released slot has no scene left pointing at it" },
        ...
        { "Desert/Desert/Source/Engine/Text/FontBaker.cpp",
          "RawGlyph", "Bitmap", Guard::OwningRaw,
          "the stb_truetype bitmap this glyph owns between baking and packing; freed by the baker" },
        { "Desert/Desert/Source/Engine/Text/FontBaker.cpp",
          "Placed", "G", Guard::CallScoped,
          "points at a RawGlyph in the vector the packer was handed, for the duration of the pack" },
        { "Desert/Desert/Source/Engine/Text/FontBaker.cpp",
