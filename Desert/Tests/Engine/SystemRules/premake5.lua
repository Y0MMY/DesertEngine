...
project(test_name)
    ...
    -- Header-only rules (Engine/ECS/System/SystemRules.hpp): the gameplay DECISIONS without the Scene
    -- they normally hang off, so there is no renderer and nothing to link.
    files {
        test_files,
    }
