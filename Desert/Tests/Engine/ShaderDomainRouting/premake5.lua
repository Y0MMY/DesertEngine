...
project(test_name)
    ...
    files {
        test_files,
        -- The parser comes along so the domain relations can be asserted against a shader's own
        -- source text rather than against a hand-built ShaderProgramMeta: the defect this suite
