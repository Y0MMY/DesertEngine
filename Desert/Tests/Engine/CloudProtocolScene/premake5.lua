...
project(test_name)
    ...
    -- The migration is here because the protocol scenes must be at the CURRENT generation: a file the
    -- loader migrates is a file whose numbers the renderer does not read off the disk.
    files {
        test_files,
