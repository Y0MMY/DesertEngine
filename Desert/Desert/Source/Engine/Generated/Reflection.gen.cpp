        ...
        DesertReflectionAutoRegister()
        {
            ...
            }
            {
                ...
                TypeBuilder( "TerrainData", sizeof( T ) )
                    ...
                    .Field( FieldInfo{ .Name = "GrassTint", .Type = FieldType::Vec3, .Offset = offsetof( T, GrassTint ), .Size = sizeof( T::GrassTint ), .TypeName = "glm::vec3", .Meta = PropertyMetadata{ .DisplayName = "Grass Tint", .Category = "Grass", .IsColor = true, } } )
                    .Register();
            }
            {
