        ...
        DesertReflectionAutoRegister()
        {
            ...
            }
            {
                ...
                TypeBuilder( "UIPanelData", sizeof( T ) )
                    ...
                    .Field( FieldInfo{ .Name = "VideoPath", .Type = FieldType::String, .Offset = offsetof( T, VideoPath ), .Size = sizeof( T::VideoPath ), .TypeName = "std::string", .Meta = PropertyMetadata{ .DisplayName = "Video Path (.mpg)", .Category = "UI Panel", } } )
