        ...
        DesertReflectionAutoRegister()
        {
            ...
            }
            {
                ...
                TypeBuilder( "CameraData", sizeof( T ) )
                    ...
                    .Field( FieldInfo{ .Name = "Near", .Type = FieldType::Float, .Offset = offsetof( T, Near ), .Size = sizeof( T::Near ), .TypeName = "float", .Meta = PropertyMetadata{ .DisplayName = "Near", .Category = "Camera", .Tooltip = "Near clip plane distance. Anything closer is not drawn.", .HasRange = true, .RangeMin = 1.0f, .RangeMax = 1000.0f, } } )
                    .Field( FieldInfo{ .Name = "Far", .Type = FieldType::Float, .Offset = offsetof( T, Far ), .Size = sizeof( T::Far ), .TypeName = "float", .Meta = PropertyMetadata{ .DisplayName = "Far", .Category = "Camera", .Tooltip = "Far clip plane distance. Anything beyond is not drawn.", .HasRange = true, .RangeMin = 1000.0f, .RangeMax = 1000000.0f, } } )
                    .WithDefault<T>()
                    .Register();
            }
            {
                ...
                TypeBuilder( "TerrainData", sizeof( T ) )
                    .Field( FieldInfo{ .Name = "Size", .Type = FieldType::Float, .Offset = offsetof( T, Size ), .Size = sizeof( T::Size ), .TypeName = "float", .Meta = PropertyMetadata{ .DisplayName = "Size", .Category = "Terrain", .HasRange = true, .RangeMin = 100.0f, .RangeMax = 50000.0f, } } )
                    ...
                    .Field( FieldInfo{ .Name = "HeightScale", .Type = FieldType::Float, .Offset = offsetof( T, HeightScale ), .Size = sizeof( T::HeightScale ), .TypeName = "float", .Meta = PropertyMetadata{ .DisplayName = "Height Scale", .Category = "Terrain", .HasRange = true, .RangeMin = 0.0f, .RangeMax = 5000.0f, } } )
                    ...
                    .Field( FieldInfo{ .Name = "GrassHeight", .Type = FieldType::Float, .Offset = offsetof( T, GrassHeight ), .Size = sizeof( T::GrassHeight ), .TypeName = "float", .Meta = PropertyMetadata{ .DisplayName = "Grass Height", .Category = "Grass", .HasRange = true, .RangeMin = 5.0f, .RangeMax = 500.0f, } } )
            ...
            }
            {
                ...
                TypeBuilder( "PointLightData", sizeof( T ) )
                    .Field( FieldInfo{ .Name = "Color", .Type = FieldType::Vec3, .Offset = offsetof( T, Color ), .Size = sizeof( T::Color ), .TypeName = "glm::vec3", .Meta = PropertyMetadata{ .DisplayName = "Color", .Category = "Light", .IsColor = true, } } )
                    .Field( FieldInfo{ .Name = "Intensity", .Type = FieldType::Float, .Offset = offsetof( T, Intensity ), .Size = sizeof( T::Intensity ), .TypeName = "float", .Meta = PropertyMetadata{ .DisplayName = "Intensity", .Category = "Light", .HasRange = true, .RangeMin = 0.0f, .RangeMax = 10.0f, } } )
                    .Field( FieldInfo{ .Name = "Radius", .Type = FieldType::Float, .Offset = offsetof( T, Radius ), .Size = sizeof( T::Radius ), .TypeName = "float", .Meta = PropertyMetadata{ .DisplayName = "Radius", .Category = "Light", .HasRange = true, .RangeMin = 0.0f, .RangeMax = 10000.0f, } } )
                    .Field( FieldInfo{ .Name = "MinRadius", .Type = FieldType::Float, .Offset = offsetof( T, MinRadius ), .Size = sizeof( T::MinRadius ), .TypeName = "float", .Meta = PropertyMetadata{ .DisplayName = "Min Radius", .Category = "Light", .HasRange = true, .RangeMin = 0.0f, .RangeMax = 10000.0f, } } )
            ...
            }
            {
                ...
                TypeBuilder( "SpotLightData", sizeof( T ) )
                    .Field( FieldInfo{ .Name = "Color", .Type = FieldType::Vec3, .Offset = offsetof( T, Color ), .Size = sizeof( T::Color ), .TypeName = "glm::vec3", .Meta = PropertyMetadata{ .DisplayName = "Color", .Category = "Light", .IsColor = true, } } )
                    .Field( FieldInfo{ .Name = "Intensity", .Type = FieldType::Float, .Offset = offsetof( T, Intensity ), .Size = sizeof( T::Intensity ), .TypeName = "float", .Meta = PropertyMetadata{ .DisplayName = "Intensity", .Category = "Light", .HasRange = true, .RangeMin = 0.0f, .RangeMax = 10.0f, } } )
                    .Field( FieldInfo{ .Name = "Range", .Type = FieldType::Float, .Offset = offsetof( T, Range ), .Size = sizeof( T::Range ), .TypeName = "float", .Meta = PropertyMetadata{ .DisplayName = "Range", .Category = "Light", .HasRange = true, .RangeMin = 0.0f, .RangeMax = 10000.0f, } } )
            ...
            }
            {
                ...
                TypeBuilder( "ParticleEmitterData", sizeof( T ) )
                    ...
                    .Field( FieldInfo{ .Name = "StartSize", .Type = FieldType::Float, .Offset = offsetof( T, StartSize ), .Size = sizeof( T::StartSize ), .TypeName = "float", .Meta = PropertyMetadata{ .DisplayName = "Start Size", .Category = "Look", .HasRange = true, .RangeMin = 0.0f, .RangeMax = 1000.0f, } } )
                    ...
                    .Field( FieldInfo{ .Name = "EndSize", .Type = FieldType::Float, .Offset = offsetof( T, EndSize ), .Size = sizeof( T::EndSize ), .TypeName = "float", .Meta = PropertyMetadata{ .DisplayName = "End Size", .Category = "Look", .HasRange = true, .RangeMin = 0.0f, .RangeMax = 1000.0f, } } )
            ...
            }
            {
                ...
                TypeBuilder( "ColliderData", sizeof( T ) )
                    ...
                    .Field( FieldInfo{ .Name = "Radius", .Type = FieldType::Float, .Offset = offsetof( T, Radius ), .Size = sizeof( T::Radius ), .TypeName = "float", .Meta = PropertyMetadata{ .DisplayName = "Radius", .Category = "Collider", .HasRange = true, .RangeMin = 1.0f, .RangeMax = 5000.0f, } } )
                    .Field( FieldInfo{ .Name = "HalfHeight", .Type = FieldType::Float, .Offset = offsetof( T, HalfHeight ), .Size = sizeof( T::HalfHeight ), .TypeName = "float", .Meta = PropertyMetadata{ .DisplayName = "Half Height", .Category = "Collider", .HasRange = true, .RangeMin = 1.0f, .RangeMax = 5000.0f, } } )
                    .WithDefault<T>()
                    .Register();
            }
            {
            ...
            }
            {
                ...
                TypeBuilder( "CharacterControllerData", sizeof( T ) )
                    .Field( FieldInfo{ .Name = "Radius", .Type = FieldType::Float, .Offset = offsetof( T, Radius ), .Size = sizeof( T::Radius ), .TypeName = "float", .Meta = PropertyMetadata{ .DisplayName = "Radius", .Category = "Character", .HasRange = true, .RangeMin = 5.0f, .RangeMax = 500.0f, } } )
                    .Field( FieldInfo{ .Name = "Height", .Type = FieldType::Float, .Offset = offsetof( T, Height ), .Size = sizeof( T::Height ), .TypeName = "float", .Meta = PropertyMetadata{ .DisplayName = "Height", .Category = "Character", .HasRange = true, .RangeMin = 20.0f, .RangeMax = 1000.0f, } } )
                    ...
                    .Field( FieldInfo{ .Name = "Gravity", .Type = FieldType::Float, .Offset = offsetof( T, Gravity ), .Size = sizeof( T::Gravity ), .TypeName = "float", .Meta = PropertyMetadata{ .DisplayName = "Gravity", .Category = "Character", .HasRange = true, .RangeMin = 0.0f, .RangeMax = 6000.0f, } } )
                    .WithDefault<T>()
                    .Register();
            }
