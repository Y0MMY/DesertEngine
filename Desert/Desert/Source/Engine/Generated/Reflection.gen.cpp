        ...
        DesertReflectionAutoRegister()
        {
            ...
            }
            {
                ...
                TypeBuilder( "UIPanelData", sizeof( T ) )
                    ...
                    .Field( FieldInfo{ .Name = "PulseSpeed", .Type = FieldType::Float, .Offset = offsetof( T, PulseSpeed ), .Size = sizeof( T::PulseSpeed ), .TypeName = "float", .Meta = PropertyMetadata{ .DisplayName = "Pulse Speed", .Category = "Animation", .HasRange = true, .RangeMin = 0.1f, .RangeMax = 10.0f, } } )
                    .Field( FieldInfo{ .Name = "PulseMin", .Type = FieldType::Float, .Offset = offsetof( T, PulseMin ), .Size = sizeof( T::PulseMin ), .TypeName = "float", .Meta = PropertyMetadata{ .DisplayName = "Pulse Min", .Category = "Animation", .HasRange = true, .RangeMin = 0.0f, .RangeMax = 1.0f, } } )
                    ...
                    .Field( FieldInfo{ .Name = "GradientColor", .Type = FieldType::Vec3, .Offset = offsetof( T, GradientColor ), .Size = sizeof( T::GradientColor ), .TypeName = "glm::vec3", .Meta = PropertyMetadata{ .DisplayName = "Gradient Color", .Category = "Effects", .IsColor = true, } } )
