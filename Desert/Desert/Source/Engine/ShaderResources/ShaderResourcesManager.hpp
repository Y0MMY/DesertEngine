...
namespace Desert::ShaderResources
{
     ...
     */
    class ShaderResourcesManager final
    {
    public:
        explicit ShaderResourcesManager( const std::string_view                  debugName,
        ...
        static std::shared_ptr<ShaderResourcesManager> Create( const std::string_view                  debugName,
                                                            const std::shared_ptr<Graphic::Shader>& shader );
